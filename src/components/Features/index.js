...
const FirstFeatures = [
  {
    title: <Translate>Kullanıcılarınızı Doğrulayın (OTP)</Translate>,
    description: <Translate>Müşterilerinizin cep telefonuna doğrulama sms'i göndererek, cep telefonunu doğrulanmasınız sağlayın.</Translate>
  },
  {
    title: <Translate>30 Farklı Senaryo</Translate>,
    description: <Translate>Sisteminizde oluşan 30'a yakın olaya sms bildirimi ekleyin.</Translate>,
  },
  {
