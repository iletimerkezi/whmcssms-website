...
const config = {
  title: 'Ücretsiz WHMCS SMS Eklentisi - İleti Merkezi',
  tagline: 'WHMCS SMS modülü, kullanıcılarınıza daha kaliteli bir müşteri deneyimi sunmanız için tasarlanmıştır. Hemen deneyin.',
  url: 'https://whmcssms.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'whmcssms-website', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Whmcs SMS T.C. Bilgi Teknolojileri ve İletişim Kurumu (BTK) tarafından yetkilendirilmiş işletmeci olan eMarka İletişim ve Bilgi Teknolojileri A.Ş. ye ait bir markadır.`,
      },
      prism: {
